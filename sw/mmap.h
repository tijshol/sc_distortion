...
#define  SYS_BIAS_RAM_SIZE   BIAS_SIZE

#define  SYS_FILTER_RAM_BASE   0xB1000000
#define  SYS_FILTER_RAM_SIZE   WEIGHT_SIZE

#define  SYS_INPUT_RAM_BASE   0xB2000000
#define  SYS_INPUT_RAM_SIZE   TENSOR_SIZE

#define  SYS_OUTPUT_RAM_BASE   0xB4000000
#define  SYS_OUTPUT_RAM_SIZE   OUTPUT_TENSOR_SIZE

#define  SYS_CONS_BASE   0x18000000
...
#define  SYS_AXI_SIZE   (SYS_AXI_TOP - SYS_AXI_BASE)
#define  SYS_AXI_TOP   0xAFFFFFFF
